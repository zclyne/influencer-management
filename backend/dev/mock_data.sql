...
INSERT INTO deals (id, campaign_id, influencer_id, status, lost_reason, labels_json, internal_notes, source_list_status, archived_at, created_at, updated_at) VALUES
  ...
  ('99999999-9999-9999-9999-999999999992', '22222222-2222-2222-2222-222222222221', '44444444-4444-4444-4444-444444444443', 'ACTIVE', NULL, json('["beauty","LATAM"]'), 'Negotiating usage rights.', 'Manual shortlist', NULL, '2026-04-10 09:05:00', '2026-04-26 12:00:00'),
  ('99999999-9999-9999-9999-999999999993', '22222222-2222-2222-2222-222222222221', '44444444-4444-4444-4444-444444444447', 'ACTIVE', NULL, json('["k-beauty","follow-up"]'), 'Initial outreach sent.', 'Imported from Modash', NULL, '2026-04-10 09:10:00', '2026-04-25 12:00:00'),
  ('99999999-9999-9999-9999-999999999994', '22222222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444442', 'DRAFT', NULL, json('["outdoor","manager"]'), 'Approved for kit seeding.', 'Manual shortlist', NULL, '2026-04-11 09:00:00', '2026-04-24 12:00:00'),
  ('99999999-9999-9999-9999-999999999995', '22222222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444445', 'ACTIVE', NULL, json('["travel","reimbursement"]'), 'Manager asked for travel terms.', 'Manual shortlist', NULL, '2026-04-11 09:05:00', '2026-04-23 12:00:00'),
